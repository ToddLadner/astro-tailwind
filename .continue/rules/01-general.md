...
alwaysApply: true
description: Core safeguards and working style for all tasks in this project.
---
...
- Preserve existing behavior and public component APIs unless a change is necessary.
- Before broad or multi-file changes, explain the plan and list the files likely to change.
